...
BOARD_KERNEL_CMDLINE := otg_device=1 androidboot.selinux=permissive
ifeq ($(PRODUCT_USE_DYNAMIC_PARTITIONS), true)
BOARD_KERNEL_CMDLINE += androidboot.dtbo_idx=0 androidboot.boot_devices=ffe07000.emmc androidboot.dynamic_partitions=true
endif
...
## Recovery
ifeq ($(PRODUCT_USE_DYNAMIC_PARTITIONS), true)
TARGET_RECOVERY_FSTAB := $(VENDOR_PATH)/init-files/fstab.amlogic
endif
